...
public class DisciplineServiceGenericImpl extends ServiceGenericImpl<DisciplineParam, DisciplineResult, DisciplineProcessorGenericImpl> {

    public DisciplineServiceGenericImpl() {
